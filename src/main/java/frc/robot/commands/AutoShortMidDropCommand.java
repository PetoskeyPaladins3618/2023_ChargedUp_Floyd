...
public class AutoShortMidDropCommand extends SequentialCommandGroup {
  /** Creates a new AutoShortMidDropCommand. */
  public AutoShortMidDropCommand() {
    ...
    addCommands(new AutoDriveBackwardCommand(7));
